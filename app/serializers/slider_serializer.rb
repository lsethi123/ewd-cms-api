class SliderSerializer < ActiveModel::Serializer
  embed :ids
  attributes :id, :page_id, :accessibility, :adaptive_height, :autoplay, :autoplay_speed, :arrows, :as_nav_for, :append_arrows, :prev_arrow, :next_arrow, :center_mode, :center_padding, :css_ease, :dots, :draggable, :fade, :focus_on_select, :easing, :edge_friction, :infinite, :initial_slide, :lazy_load, :mobile_first, :pause_on_hover, :pause_on_dots_hover,
